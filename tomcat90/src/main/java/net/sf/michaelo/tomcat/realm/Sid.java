 ...
 * "https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-dtyp/f992ad60-0fe4-4b87-9fed-beb478836861">{@code SID} (security
 * identifier)</a> from MS-DTYP.
 */
public class Sid {
	 ...
	 *
	 * @param sidBytes SID structure encoded as bytes
	 * @throws NullPointerException     if {@code sidBytes} is null
	 * @throws IllegalArgumentException if {@code sidBytes} contains less than 12
	 *                                  bytes
	 * @throws IllegalArgumentException if SID's revision is not 1
	 * @throws IllegalArgumentException if SID's subauthority count is more than 15
	 */
