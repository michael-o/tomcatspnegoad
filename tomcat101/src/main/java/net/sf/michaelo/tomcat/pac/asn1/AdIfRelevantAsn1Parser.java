...
/**
 * A minimalist ASN.1 parser for Kerberos {@code AuthorizationData} according to
 * RFC 4120, section 5.2.6 for the {@code AD-IF-RELEVANT} type. It unwraps all
 * nested data as described in <a href=
...
public class AdIfRelevantAsn1Parser {
	 ...
	 *
	 * @param adIfRelevant ASN.1 encoded data
	 * @return a list of {@code AuthorizationDataEntry} elements
	 * @throws NullPointerException if {@code adIfRelevant} is null
	 * @throws IllegalArgumentException if {@code adIfRelevant} is empty
	 */
