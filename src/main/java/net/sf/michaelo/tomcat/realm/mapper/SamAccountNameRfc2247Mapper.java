 ...
 * GSS name in the primary and realm component. The instance component is completely
 ...
 * 2247</a>.
 * <p>
 * <strong>Note:</strong> This mapper requires to operate from the {@code RootDSE} of a domain controller or better yet, a
 * GC. No root DN normalization (stripping DC components) happens here (yet).
 *
 * Moreover, this implementation mimics <a href="https://msdn.microsoft.com/en-us/library/ms675970%28v=vs.85%29.aspx">{@code DsCrackNames}</a>
 * with {@code formatOffered} set to {@code DS_USER_PRINCIPAL_NAME} and {@code formatDesired} set to
 * {@code DS_FQDN_1779_NAME}. Verified against <a href="https://github.com/samba-team/samba/blob/7ed24924d2917556a03c51eadcb65b3e3c1e8af6/source4/dsdb/samdb/cracknames.c#L1260">Samba's implementation</a>
 * of {@code DsCrackNames}.
 *</p>
 * @version $Id$
 */
